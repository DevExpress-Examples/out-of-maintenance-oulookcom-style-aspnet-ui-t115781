...
<%@ Page Language="vb" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeFile="Default.aspx.vb" Inherits="_Default" %>
							...
							<div style="width: 100%; bottom: 20px; position: absolute;">
								<div style="">
									<div style="margin:20px; border-top:1px solid silver; padding-top:20px;">
										 <img src="<%=Me.Author%>.jpg" style="width: 120px; float:left; margin-right:10px; margin-bottom:10px;" id="avatar" />
										 <span id="info"><%=WebDbProvider.GetAuthorDescription(Me.Author)%></span>
									</div>
								</div>                                             
							</div>
